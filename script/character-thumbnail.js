...
class CharacterThumbnail extends HTMLElement {
    ...
    updateCharacterClass(newClass) {
        this.characterImage.classList.remove(Array.prototype.find.call(this.characterImage.classList, (cl) => cl.includes("thumbnail")));
    ...
    constructor() {
        ...
        thumbnailContainer.classList.add("p1-thumbnail");
